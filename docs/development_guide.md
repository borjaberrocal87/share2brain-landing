# KeepHive Landing — Development Guide
...
```bash
git clone git@github.com:keephive/keephive-landing.git
cd keephive-landing
```
...
- `PUBLIC_GITHUB_URL` — GitHub repository URL (default: `https://github.com/keephive/keephive`)
