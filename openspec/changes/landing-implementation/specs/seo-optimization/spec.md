...
- **WHEN** page loads
- **THEN** title tag contains "Share2Brain - AI Agent for Discord Communities"
...
- **WHEN** page loads
- **THEN** canonical link tag points to https://share2brain.app
...
- **THEN** alt text describes the Share2Brain logo
